        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto animate-fade-in-up">
            ...
            <p className="text-xl text-muted-foreground">
              Ready to book a sitter or have questions? We're here to help! Fill out the form below or reach out directly.
            </p>
          </div>
        </div>
      </section>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">hello@pawcareto.com</p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        onChange={handleChange}
                        placeholder="Tell us about your pet sitting needs..."
                        rows={6}
                        required
                      />
                    </div>
