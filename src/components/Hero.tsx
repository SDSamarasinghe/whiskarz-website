        ...
        <motion.div className="max-w-4xl">
          <motion.div variants={badgeVariants} className="mb-8">
            <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm text-white px-5 py-2.5 rounded-full border border-white/30 shadow-lg">
              <span className="text-sm font-semibold">Trusted by 500+ Happy Pet Families in Toronto</span>
            </div>
          </motion.div>
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Professional, loving pet care services in Toronto. Because your furry friends deserve the best attention while you're away.
          </motion.p>
